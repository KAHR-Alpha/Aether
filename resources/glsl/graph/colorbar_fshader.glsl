...
void main(void)
{
         if(color_palette==0) color=BW_gradient(gradient_value);
    else if(color_palette==1) color=jet_gradient(gradient_value);
    else if(color_palette==2) color=extended_jet_gradient(gradient_value);
}
