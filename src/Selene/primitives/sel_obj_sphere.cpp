...
namespace Sel::Primitives
{
    ...
    double Sphere::get_cut_factor() const { return sph_cut; }
    double Sphere::get_radius() const { return sph_r; }
    ...
    double& Sphere::ref_cut_factor() { return sph_cut; }
    double& Sphere::ref_radius() { return sph_r; }
