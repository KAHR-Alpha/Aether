...
//        void init(int Nx,int Ny,int Nz,double Dx,double Dy,double Dz);
        ...
        void solve_prop_1D(double lambda,Angle theta,Angle phi,Angle polar);
        void solve_prop_2D(double lambda,Angle theta,Angle phi,Angle polar);
        void solve_prop_3D(double lambda,Angle theta,Angle phi,Angle polar);
        
        void solve_prop_3D_SAM(double lambda,Angle theta,Angle phi,Angle polar);
